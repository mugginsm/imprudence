...
const std::string RttCameraDispatchHandler::mMessageID("RexRttCam");
...
{
   std::string strCommand = string[0];
   std::string name = string[1];
   std::string imageId = string[2];
   std::string strPos = string[3];
   std::string strLookAt = string[4];
   std::string strWidth = string[5];
   std::string strHeight = string[6];
...
const std::string RexViewportDispatchHandler::mMessageID("RexSetViewport");
