...
const std::string EffectParticleDispatchHandler::smMessageID("RexCSEffect");
...
const std::string EffectStationaryParticleDispatchHandler::smMessageID("RexSCSEffect");
