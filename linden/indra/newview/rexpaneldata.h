...
public:
	...
	std::map<std::string, std::string> parseRexData(std::string data);
...
public:
	...
	static BOOL processRexParameterMap(std::map<std::string, std::string> parameter_map, const LLVector3d& obj_pos_global);
