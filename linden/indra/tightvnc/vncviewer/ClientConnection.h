...
class TIGHTVNC_EXPORT ClientConnection  : public omni_thread
{
public:
...
private:
    ...
    omni_mutex m_suMutex;
    typedef std::vector<VNCScreenUpdateListener*> ScreenUpdateListenerList;
    ScreenUpdateListenerList m_suListeners;
