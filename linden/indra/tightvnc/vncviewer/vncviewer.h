...
TIGHTVNC_EXPORT void* GetVNCModule();
TIGHTVNC_EXPORT void SetVNCApp(VNCviewerApp* app);
TIGHTVNC_EXPORT VNCviewerApp* GetVNCApp();
TIGHTVNC_EXPORT Log& GetVNCLog();
TIGHTVNC_EXPORT VNCHelp& GetVNCHelp();
TIGHTVNC_EXPORT HotKeys& GetVNCHotkeys();
...
TIGHTVNC_EXPORT bool ParseDisplay(LPTSTR display, LPTSTR phost, int hostlen, int *port);
...
{
	if (GetVNCApp()->m_options.m_palmpc)
